...
export function StepPrompts() {
  ...
  const handleNext = () => {
    ...
    // Also store on window for StepGenerate fallback
    window._gptParams = params;
    markStepDone(5);
    setCurrentStep(6);
  };
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div className="bg-bg-card border border-border-subtle rounded-2xl p-5 backdrop-blur-md">
        ...
        <textarea rows="4" placeholder="Du bist ein professioneller Audiodeskriptions-Autor…"
      ...
      <div className="bg-bg-card border border-border-subtle rounded-2xl p-5 backdrop-blur-md">
        ...
        <textarea rows="3" placeholder="Erstelle eine präzise Audiodeskription für die folgenden Szenenbilder…"
      ...
      <div className="bg-bg-card border border-border-subtle rounded-2xl p-5 backdrop-blur-md">
        ...
        <textarea rows="4" placeholder="1. Beschreibe Handlungen im Präsens…"
      ...
      <div className="bg-bg-card border border-border-subtle rounded-2xl p-5 backdrop-blur-md">
        ...
        <textarea rows="3" placeholder="Beispiel 1: …"
